...
namespace KartGame.KartSystems
{
    public class ArcadeKart : MonoBehaviour
    {
        ...
        public GameObject kart_body;
        public GameObject[] kart_wheels;
        ...
        //CHECKS if the player collided with a pickup object and interacts with it.
          private void OnTriggerEnter(Collider other)
          {
              IPickUp obj = other.GetComponent<IPickUp>();
              if(obj != null)
              {
                  obj.PickedUp();
              }
          ...
          //Player is able to jump whenever he wants
          private void Jump()
          {
              if (!m_InAir)
              {
                         if (Input.Jump) { Debug.Log("Jump!"); Rigidbody.velocity += new Vector3(0,baseStats.JumpForce, 0);}
              }
          }
         ...
         //Player is forced to jump
          ...
          {
              Rigidbody.velocity += new Vector3(0,baseStats.JumpForce*2.5f, 0);
          }
    }
}
